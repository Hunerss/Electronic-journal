...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2024 at 09:50 PM
...
(2, 'Joanna', 'Nowak', 19766907, 2),
(3, 'Andrzej', 'Kowalski', 19614459, 1),
(4, 'Maria', 'Kowalska', 19691214, 2),
(5, 'Marek', 'Wiśniewski', 19660021, 1),
(6, 'Małgorzata', 'Wiśniewska', 19817793, 2),
(7, 'Jan', 'Wójcik', 19792512, 1),
(8, 'Barbara', 'Wójcik', 19679526, 2),
(9, 'Marcin', 'Kowalczyk', 19638132, 1),
(10, 'Barbara', 'Kowalczyk', 19751755, 2),
(11, 'Piotr', 'Kamiński', 19645957, 1),
(12, 'Agnieszka', 'Kamińska', 19704188, 2),
(13, 'Krzysztof', 'Lewandowski', 19655258, 1),
(14, 'Anna', 'Lewandowska', 19786073, 2),
(15, 'Tomasz', 'Zieliński', 19694057, 1),
(16, 'Magdalena', 'Zielińska', 19679657, 2),
(17, 'Jan', 'Woźniak', 19609608, 1),
(18, 'Katarzyna', 'Woźniak', 19809558, 2),
(19, 'Piotr', 'Szymański', 19675153, 1),
(20, 'Maria', 'Szymańska', 19758601, 2),
(21, 'Tomasz', 'Dąbrowski', 19647264, 1),
(22, 'Barbara', 'Dąbrowska', 19692205, 2),
(23, 'Andrzej', 'Kozłowski', 19691690, 1),
(24, 'Maria', 'Kozłowska', 19687041, 2),
(25, 'Grzegorz', 'Mazur', 19651066, 1),
(26, 'Agnieszka', 'Mazurska', 19738672, 2),
(27, 'Grzegorz', 'Jankowski', 19662419, 1),
(28, 'Agnieszka', 'Jankowska', 19833277, 2),
(29, 'Marek', 'Kwiatkowski', 19678237, 1),
(30, 'Zofia', 'Kwiatkowska', 19670952, 2),
(31, 'Tomasz', 'Wojciechowski', 19631368, 1),
(32, 'Małgorzata', 'Wojciechowska', 19849399, 2),
(33, 'Marek', 'Krawczyk', 19786111, 1),
(34, 'Joanna', 'Krawczyk', 19670762, 2),
(35, 'Tomasz', 'Kaczmarek', 19737003, 1),
(36, 'Zofia', 'Kaczmarek', 19838519, 2),
(37, 'Marek', 'Piotrowski', 19725038, 1),
(38, 'Anna', 'Piotrowska', 19707886, 2),
(39, 'Tomasz', 'Grabowski', 19656298, 1),
(40, 'Joanna', 'Grabowska', 19748928, 2),
(41, 'Piotr', 'Zając', 19731849, 1),
(42, 'Zofia', 'Zając', 19675527, 2),
(43, 'Marcin', 'Pawłowski', 19666196, 1),
(44, 'Barbara', 'Pawłowska', 19790230, 2),
(45, 'Adam', 'Król', 19718191, 1),
(46, 'Magdalena', 'Król', 19718313, 2),
(47, 'Grzegorz', 'Michalski', 19756772, 1),
(48, 'Katarzyna', 'Michalska', 19761946, 2),
(49, 'Krzysztof', 'Wróbel', 19797785, 1),
(50, 'Agnieszka', 'Wróbel', 19798653, 2),
(51, 'Tomasz', 'Wieczorek', 19716409, 1),
(52, 'Magdalena', 'Wieczorek', 19815920, 2),
(53, 'Grzegorz', 'Jabłoński', 19767114, 1),
(54, 'Magdalena', 'Jabłońska', 19729042, 2),
(55, 'Andrzej', 'Nowakowski', 19770128, 1),
(56, 'Anna', 'Nowakowska', 19750652, 2),
(57, 'Piotr', 'Majewski', 19753783, 1),
(58, 'Magdalena', 'Majewska', 19850521, 2),
(59, 'Piotr', 'Olszewski', 19712307, 1),
(60, 'Barbara', 'Olszewska', 19675962, 2);
...
(2, 'Maria', 'Kowalska', '1A', 20090106, 15, 4.12, 2, 3, 4),
(3, 'Paweł', 'Wiśniewski', '1A', 20097196, 15, 3.85, 1, 5, 6),
(4, 'Barbara', 'Wójcik', '1A', 20101151, 14, 4, 2, 7, 8),
(5, 'Andrzej', 'Kowalczyk', '1A', 20099545, 15, 4.11, 1, 9, 10),
(6, 'Małgorzata', 'Kamińska', '1A', 20087262, 16, 4.74, 2, 11, 12),
(7, 'Jan', 'Lewandowski', '1A', 20104967, 14, 4.21, 1, 13, 14),
(8, 'Katarzyna', 'Zielińska', '1A', 20104971, 14, 4.32, 2, 15, 16),
(9, 'Krzysztof', 'Woźniak', '1A', 20111460, 13, 3.92, 1, 17, 18),
(10, 'Zofia', 'Szymańska', '1A', 20104812, 14, 3.67, 2, 19, 20),
(11, 'Adam', 'Dąbrowski', '1A', 20090479, 15, 4.13, 1, 21, 22),
(12, 'Magdalena', 'Kozłowska', '1A', 20080735, 16, 4.56, 2, 23, 24),
(13, 'Paweł', 'Mazur', '1A', 20090106, 15, 4.15, 1, 25, 26),
(14, 'Anna', 'Jankowska', '1A', 20107390, 14, 3.98, 2, 27, 28),
(15, 'Tomasz', 'Kwiatkowski', '1A', 20101962, 14, 4.7, 1, 29, 30),
(16, 'Marek', 'Wojciechowski', '1A', 20087486, 16, 3.86, 1, 31, 32),
(17, 'Zofia', 'Krawczyk', '1A', 20116588, 13, 4.02, 2, 33, 34),
(18, 'Piotr', 'Kaczmarek', '1A', 20092085, 15, 4.2, 1, 35, 36),
(19, 'Joanna', 'Piotrowska', '1A', 20103606, 14, 3.78, 2, 37, 38),
(20, 'Tomasz', 'Grabowski', '1A', 20089545, 16, 4.6, 1, 39, 40),
(21, 'Zofia', 'Zając', '1A', 20089471, 16, 3.91, 2, 41, 42),
(22, 'Marek', 'Pawłowski', '1A', 20098745, 15, 3.75, 1, 43, 44),
(23, 'Anna', 'Król', '1A', 20105165, 14, 3.98, 2, 45, 46),
(24, 'Krzysztof', 'Michalski', '1A', 20106234, 14, 4.5, 1, 47, 48),
(25, 'Maria', 'Wróbel', '1A', 20106555, 14, 4.12, 2, 49, 50),
(26, 'Adam', 'Wieczorek', '1A', 20098415, 15, 3.85, 1, 51, 52),
(27, 'Joanna', 'Jabłońska', '1A', 20094560, 15, 3.93, 2, 53, 54),
(28, 'Piotr', 'Nowakowski', '1A', 20093478, 15, 3.76, 1, 55, 56),
(29, 'Zofia', 'Majewska', '1A', 20106588, 14, 4.38, 2, 57, 58),
(30, 'Tomasz', 'Olszewski', '1A', 20089345, 16, 3.99, 1, 59, 60);
...
(1, 'Anna', 'Nowak', 'Język polski', '1a', 101, 19800512, 44, 2),
(2, 'Jan', 'Kowalski', 'Matematyka', '1b', 102, 19770516, 47, 1),
(3, 'Maria', 'Wiśniewska', 'Język angielski', '1c', 103, 19890815, 35, 2),
(4, 'Tomasz', 'Wójcik', 'Historia', '1d', 104, 19691224, 54, 1),
(5, 'Ewa', 'Kowalczyk', 'Wiedza o społeczeństwie (WOS)', '2a', 105, 19830729, 41, 2),
(6, 'Krzysztof', 'Kamiński', 'Geografia', '2b', 106, 19900118, 34, 1),
(7, 'Marek', 'Lewandowski', 'Biologia', '2c', 107, 19850907, 39, 1),
(8, 'Magdalena', 'Zielińska', 'Chemia', '2d', 108, 19870730, 37, 2),
(9, 'Piotr', 'Woźniak', 'Fizyka', '3a', 109, 19911019, 33, 1),
(10, 'Agnieszka', 'Szymańska', 'Informatyka', '3b', 110, 19810122, 43, 2),
(11, 'Jacek', 'Dąbrowski', 'Wychowanie fizyczne (WF)', '', 0, 19751230, 48, 1),
(12, 'Joanna', 'Kozłowska', 'Edukacja dla bezpieczeństwa (EDB)', '3c', 113, 19861205, 37, 2),
(13, 'Katarzyna', 'Mazur', 'Religia', '', 114, 19790801, 45, 2),
(14, 'Grzegorz', 'Jankowski', 'Etyka', '', 115, 19890316, 35, 1),
(15, 'Rafał', 'Kwiatkowski', 'Język rosyjski', '3d', 116, 19841110, 40, 1),
(16, 'Anna', 'Wojciechowska', 'Podstawy przedsiębiorczości', '4a', 117, 19910425, 33, 2),
(17, 'Iwona', 'Krawczyk', 'Wychowanie fizyczne (WF)', '4b', 0, 19931220, 30, 2),
(18, 'Paweł', 'Kaczmarek', 'Język angielski', '4c', 119, 19871001, 37, 1),
(19, 'Barbara', 'Piotrowska', 'Matematyka', '4d', 120, 19760606, 48, 2),
(20, 'Maciej', 'Grabowski', 'Język angielski', '', 201, 19890905, 35, 1),
(21, 'Monika', 'Zając', 'Język angielski', '', 202, 19801219, 43, 2),
(22, 'Wojciech', 'Król', 'Język polski', '', 203, 19900411, 34, 1),
(23, 'Piotr', 'Wróbel', 'Matematyka', '', 204, 19740828, 50, 1),
(24, 'Zofia', 'Wieczorek', 'Język angielski', '', 205, 19930914, 31, 2),
(25, 'Robert', 'Jabłoński', 'Matematyka', '', 206, 19810525, 43, 1),
(26, 'Marta', 'Nowakowska', 'Wychowanie fizyczne (WF)', '', 0, 19770330, 47, 2),
(27, 'Grzegorz', 'Majewski', 'Matematyka', '', 207, 19851018, 39, 1),
(28, 'Kamil', 'Olszewski', 'Filozofia', '', 208, 19911202, 33, 1),
(29, 'Ewa', 'Stępień', 'Język polski', '', 209, 19831215, 40, 2),
